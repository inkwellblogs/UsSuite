-- DEBUG: Check karo kya kya available hai
task.spawn(function()
    task.wait(5)
    print("===== DEBUG INFO =====")
    ...
    pcall(function()
        ...
        if assets then
            ...
            if remotes then
                print("GET Remote:", remotes:FindFirstChild("GET") and "FOUND" or "NOT FOUND")
                print("POST Remote:", remotes:FindFirstChild("POST") and "FOUND" or "NOT FOUND")
            else
    ...
    if interface then
        ...
        print("  HUD:", interface:FindFirstChild("HUD") and "FOUND" or "NOT FOUND")
        print("  Rewards:", interface:FindFirstChild("Rewards") and "FOUND" or "NOT FOUND")
        print("  Customisation:", interface:FindFirstChild("Customisation") and "FOUND" or "NOT FOUND")
    else
        print("Interface: NOT FOUND")
    end
    
    -- Check Workspace
    print("Unclimbable:", workspace:FindFirstChild("Unclimbable") and "FOUND" or "NOT FOUND")
    print("Titans:", workspace:FindFirstChild("Titans") and "FOUND" or "NOT FOUND")
    print("Climbable:", workspace:FindFirstChild("Climbable") and "FOUND" or "NOT FOUND")
    print("===== DEBUG END =====")
end)
